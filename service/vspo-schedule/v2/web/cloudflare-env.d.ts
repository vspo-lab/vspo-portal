/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: afa5df61460ce7e826fe0c3097916828)
// Runtime types generated with workerd@1.20250507.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
import type { Env } from "./src/features/shared/types/api";

declare namespace Cloudflare {
  interface Env extends Omit<import("./src/features/shared/types/api").Env, "ENV" | "API_URL_V2" | "ASSETS"> {
    ENV: string;
    API_URL_V2: string;
    ASSETS: Fetcher;
  }
