...
This Service uses Google Analytics, provided by Google Inc. (hereinafter referred to as "Google"), as a third-party service for the purpose of analyzing and improving the Service.

This third-party service may analyze usage through cookies, and in this process, some user information such as IP addresses may be collected by its operator. By using this Service, users are deemed to have granted permission for data processing performed by the third-party service operator for the above methods and purposes.

1. [About Google's privacy policy for services provided](https://policies.google.com/privacy)
